...
avatarTemplate.menu.init=function(){avatarMenu.responsive.toggleButton();}})(jQuery);(function($){avatarImage={}
avatarImage.effects={}
...
avatarMenu.responsive.toggleButton=function(){$('.avatar-nav-responsive .toggle').click(function(){var toggle=$(this);var parent=toggle.parent();parent.find('ul.avatar-main-menu').slideToggle();$(window).resize(function(){if($(window).width()>1024){parent.find('ul.avatar-main-menu').removeAttr('style');}});});}})(jQuery);